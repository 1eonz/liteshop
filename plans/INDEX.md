...
| plan-29 | 商城低代码扩展与后台页面管理 | 4.3、D3.3、D3.4、D6.7 | 进行中：页面管理、编辑器增强、模板和变体待收口 |

## 三期计划

| Plan | 范围 | PRD 章节 | 当前状态 |
|---|---|---|---|
| plan-30 | 3D 组件基础、设备降级与性能约束 | 4.4.7、D8.3 | 进行中：共享 3D 配置工具与降级组件待接入页面 |
| plan-31 | 多租户、营销工具、物流轨迹与 AI 扩展 | 7.4、D4.5、D6.3.3 | 待实施：先交付可插拔基础契约，第三方服务接入单独记录 |
